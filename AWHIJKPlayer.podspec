#
#  Be sure to run `pod spec lint AWHIJKPlayer.podspec' to ensure this is a
#  确保运行“pod spec lint AWHIJKPlayer.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "AWHIJKPlayer"
  s.version      = "0.0.1"
  s.summary      = "A short description of AWHIJKPlayer."
  ...
  s.homepage     = "https://github.com/WHWorkDevelopment/AWHIJKPlayer-iOS.git"
  ...
  # s.authors            = { "王恒" => "1066026709@qq.com" }
   s.social_media_url   = "https://github.com/WHWorkDevelopment/AWHIJKPlayer-iOS"
  ...
  s.source       = { :git => "https://github.com/WHWorkDevelopment/AWHIJKPlayer-iOS.git", :tag => "#{s.version}" }
  ...
  #s.source_files  = "AWHIJKPlayer/**/*.{h,m,swift,framework}"
  ## s.exclude_files = "Classes/Exclude"   #排除文件

  #s.public_header_files = "AWHIJKPlayer/**/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHIJKPlayerLocalizable.bundle']
  ...
  #s.vendored_framework = "#{s.name}-#{s.version}/ios/#{s.name}.framework"
